...
namespace ManagedX.Input.XInput
{
	...
	partial class GameController
	{
		...
		private static class NativeMethods
		{
			...
			/// <summary>Defines the XInput library name.</summary>
#if XINPUT_1_5
			internal const string LibraryName = "XInput1_5.dll";
			private static readonly Version Ver = new Version( 1, 5 );
#elif XINPUT_1_4
			internal const string LibraryName = "XInput1_4.dll";
			private static readonly Version Ver = new Version( 1, 4 );
#elif XINPUT_1_3
			internal const string LibraryName = "XInput1_3.dll";
			private static readonly Version Ver = new Version( 1, 3 );
#endif


#if XINPUT_1_5 || XBOX_ONE
			/// <summary>Defines the maximum number of supported game controllers: 8.</summary>
			internal const int MaxControllerCount = 8;
#else
			/// <summary>Defines the maximum number of supported game controllers: 4.</summary>
			internal const int MaxControllerCount = 4;
#endif


			/// <summary>Gets the version of the XInput library.</summary>
			internal static Version Version { get { return Ver; } }
			...
			internal static extern void XInputEnable(
...
//			// TODO - implement trigger vibration support :
//			[DllImport( LibraryName, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode, ExactSpelling = true, PreserveSig = true, SetLastError = false )]
//			internal static extern int XInputSetState(
//				[In] GameControllerIndex userIndex,
//				[In] ref Vibration vibration,
//				[In] ref Vibration triggers
//			);
...
//#endif
			...
			[DllImport( "XInput1_3.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode, ExactSpelling = true, PreserveSig = true, SetLastError = false )]
