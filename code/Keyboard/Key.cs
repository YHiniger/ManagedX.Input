...
namespace ManagedX.Input
{
	...
	public enum Key : int
	{
		...
		/// <summary>La touche ANNULER.</summary>
		Cancel = 3,

		///// <summary>Le bouton central de la souris (souris à trois boutons).</summary>
		//MButton = 4,

		///// <summary>Le premier bouton x de la souris (souris à cinq boutons).</summary>
		//XButton1 = 5,

		///// <summary>Le second bouton x de la souris (souris à cinq boutons).</summary>
		//XButton2 = 6,
		...
		Tab = 9,
		/// <summary>La touche SAUT DE LIGNE.</summary>
		LineFeed = 10,
		/// <summary>The CLEAR key.</summary>
		Clear = 12,
		/// <summary>La touche RETOUR.</summary>
		Return = 13,
		...
		KanaMode = 21,
		/// <summary>La touche mode Hangul IME(conservée pour la compatibilité ; utilisez HangulMode).</summary>
		HanguelMode = 21,
		...
		Escape = 27,
		/// <summary>La touche de conversion IME.</summary>
		[SuppressMessage( "Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "IME" )]
		IMEConvert = 28,
		/// <summary>La touche Nonconvert IME.</summary>
		[SuppressMessage( "Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "IME" )]
		IMENonconvert = 29,
		/// <summary>La touche Accepter IME remplace <see cref="F:System.Windows.Forms.Keys.IMEAceept" />.</summary>
		[SuppressMessage( "Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "IME" )]
		IMEAccept = 30,
		/// <summary>La touche Accepter IME.Obsolète, utilisez plutôt <see cref="F:System.Windows.Forms.Keys.IMEAccept" />.</summary>
		[SuppressMessage( "Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "IME" )]
		IMEAceept = 30,
		/// <summary>La touche de modification de mode IME.</summary>
		[SuppressMessage( "Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "IME" )]
		IMEModeChange = 31,
