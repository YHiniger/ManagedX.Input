namespace ManagedX.Input.XInput
{
	...
	public enum DeviceSubtype : byte
	{
		...
		[Source( "XInput.h", "XINPUT_DEVSUBTYPE_UNKNOWN" )]
		Unknown = 0,
		...
		[Source( "XInput.h", "XINPUT_DEVSUBTYPE_GAMEPAD" )]
		Gamepad,
		...
		[Source( "XInput.h", "XINPUT_DEVSUBTYPE_WHEEL" )]
		Wheel,
		...
		[Source( "XInput.h", "XINPUT_DEVSUBTYPE_ARCADE_STICK" )]
		ArcadeStick,
		...
		/// LB, LSB, RB, and RSB are optional.</summary>
		[Source( "XInput.h", "XINPUT_DEVSUBTYPE_FLIGHT_STICK" )]
		FlightStick,
		...
		[Source( "XInput.h", "XINPUT_DEVSUBTYPE_DANCE_PAD" )]
		DancePad,
		...
		[Source( "XInput.h", "XINPUT_DEVSUBTYPE_GUITAR" )]
		Guitar,

		/// <summary>Guitar controller.
		/// Supports a larger range of movement for the vertical orientation sensor.</summary>
		[Source( "XInput.h", "XINPUT_DEVSUBTYPE_GUITAR_ALTERNATE" )]
		GuitarAlternate,
		...
		[Source( "XInput.h", "XINPUT_DEVSUBTYPE_ARCADE_PAD" )]
		ArcadePad = 19,
